...
const PROJECTS: Project[] = [
  {
    ...
    category: "experience",
    href: "haladir.com",
    subheading: "The Operational Superintelligence Company. Joined as first hire in Summer 2026",
  },
  {
    title: "Karev",
    year: "2026",
    category: "projects",
    href: "usekarev.com",
    subheading: "Simplifying and preventing errors in medical billing. Already serving multiple clinics in the US",
  },
  {
  ...
  },
  {
    ...
    category: "experience",
    href: "leidos.com",
    subheading: "F500 government contractor. Joined to work on low latency tank simulations for US Army. Joined right after high school grad",
  },
  {
